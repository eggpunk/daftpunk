...
namespace eval incith {
  namespace eval google {
    ...
    # ------
    variable search_results 1
    variable image_results 1
    variable local_results 1
    variable group_results 1
    variable news_results 1
    variable print_results 1
    variable video_results 1
    variable scholar_results 1
    variable youtube_results 1
    variable locate_results 1
    variable gamespot_results 1
    variable trans_results 1
    variable daily_results 1  
    variable gamefaq_results 1 
    variable blog_results 1
    variable ebay_results 1
    variable popular_results 1
    variable rev_results 1
    variable wiki_results 1
    variable wikimedia_results 1
    variable recent_results 1
    variable mininova_results 1
    variable ign_results 1
    variable myspacevids_results 1
    variable trends_results 1
